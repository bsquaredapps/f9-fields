...
export type F9ComboboxDataFieldOnChangeEventHandler = (
    targetRef: React.RefObject<HTMLInputElement>,
    data: OptionOnSelectData
) => void;

export interface F9ComboboxDataFieldProps extends Omit<ComboboxProps, "contentBefore" | "contentAfter" | "onClick" | "onChange" | "value" | "size"> {
    ...
    onChange: F9ComboboxDataFieldOnChangeEventHandler;
...
export const F9ComboboxDataField: React.FunctionComponent<F9ComboboxDataFieldProps> = (props) => {
