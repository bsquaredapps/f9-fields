...
const useSecondaryTextBaseClassName = makeStyles({
  base: {
...
const useValidationMessageIconBaseClassName = makeStyles({
  base: {
...
export const useFieldStyles_unstable = (state: FieldState) => {
  ...
  if (state.validationMessageIcon) {
    state.validationMessageIcon.className = mergeClasses(
      ...
      validationMessageIconBaseClassName.base,
  ...
  if (state.validationMessage) {
    state.validationMessage.className = mergeClasses(
      ...
      secondaryTextBaseClassName.base,
  ...
  if (state.hint) {
    state.hint.className = mergeClasses(fieldClassNames.hint, secondaryTextBaseClassName.base, state.hint.className);
  }
};